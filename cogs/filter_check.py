...
FILTER_CHANNEL_ID = 1417970716636086312  # Replace with your actual channel ID
MAIN_GROUP = 34755744
...
async def fetch_roblox_user_data(session: aiohttp.ClientSession, user_id: int, interaction: discord.Interaction | None = None):
